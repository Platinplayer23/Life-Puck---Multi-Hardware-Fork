...
void renderAudioSettingsMenu()
{
  ...
  // Audio Enable/Disable Button (Row 2, Col 0)
  ...
  // Audio Volume Button (Row 2, Col 1)
  ...
  lv_obj_set_grid_cell(btn_audio_volume, LV_GRID_ALIGN_CENTER, 1, 1, LV_GRID_ALIGN_START, 2, 1);
  ...
  // Timer Sound Button (Row 3, Col 0)
  ...
  lv_obj_set_grid_cell(btn_timer_sound, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_START, 3, 1);
  ...
  lv_obj_t *spacer = lv_obj_create(audio_menu);
